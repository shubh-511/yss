    			...
    			<td style="font-family: 'Quicksand', sans-serif;">
    				...
    				<p style="margin-bottom: 10px;">
   						<span style="max-width: 50%; width: 100%; font-size: 15px; font-weight: 500; color: #6B6B6B;">
    						You have a review, navigate to your listing page to check out what people are saying about you! Only people you have worked with can leave you a review so I’m sure your review is great, if not and you believe it’s unfair, please <a style="text-decoration:none" href ="mailto:support@soberlistics.com">contact us</a> to see if we can help.
    					</span>
    				</p>
