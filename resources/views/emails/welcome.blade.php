    			...
    			<td style="padding-left: 50px; padding-right: 50px;font-family: 'Quicksand', sans-serif;">
    				...
    				<p style="margin-bottom: 10px;">
   						<span style="max-width: 50%; width: 100%; font-size: 18px; font-weight: 500; color: #6B6B6B;">
    						Welcome to SoberListic, home of the best online coaching software! We sincerely hope you enjoy your experience, if you have any issues, please <a href ="mailto:support@soberlistics.com">contact us </a> and we will do our very best to help you as quickly as possible! <br />
