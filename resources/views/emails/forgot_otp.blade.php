    			...
    			<td style="font-family: 'Quicksand', sans-serif;">
    				...
    				<p style="margin-bottom: 10px;">
   						<span style="max-width: 50%; width: 100%; font-size: 15px; font-weight: 500; color: #6B6B6B;">
    						Reset password otp is {{$user['otp']}}<br>
                            You seem to have forgotten your password, not to worry we’ve got you covered, click the link underneath to reset your password, or paste the link into your browser, thank you and have a great day!
                            <br>
                            <a style="text-decoration:none" href="https://soberlistic.com/user/request/reset-password/">https://soberlistic.com/user/request/reset-password</a>
    					</span>
    				</p>
