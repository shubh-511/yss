    			...
    			<td style="font-family: 'Quicksand', sans-serif;">
    				...
    				<p style="margin-bottom: 10px;">
   						<span style="max-width: 50%; width: 100%; font-size: 15px; font-weight: 500; color: #6B6B6B;">
    						Thank you for your booking, you have a booked your appointment with your coach {{ $user['name'] }} at {{$booking['slot']}} on {{$booking['booking_date']}}. On the day of your appointment please login to the site and navigate to your bookings, then select the booking and when your coach is ready you will see a prompt asking you to join. On your fist session your browser will ask for permission to use your camera and microphone, accept these please so your connection to your coach works! Please make sure you have a good internet connection and that you will not be interrupted so you can have the best session!
    					</span>
    				</p>
                    ...
                    <p style="margin-bottom: 20px;">
                     ...
                     <tr style="vertical-align: top;">
                        <td style="padding: 20px; word-break: break-word;border-collapse: collapse !important;vertical-align: top;font-family: 'Quicksand', sans-serif;">
