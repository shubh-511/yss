...
<div class="box-header">
    ...
    <div class="pull-right">
        <a class="btn btn-primary" href="{{ url('login/sub/admin') }}"> Back</a>
    </div>
</div>
@if (count($errors) > 0)
            ...
            <div class="box-body">
                <form action="{{url('login/sub/admin/update',[$edit_subadmin->id])}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                <button name="editsubAdmin" type="submit" class="btn btn-primary ">Update</button>
                              </div>
                            </div>
                        </div>
                 </form>
