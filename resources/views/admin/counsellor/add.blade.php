                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="listing_name" class="form-control @error('listing_name') is-invalid @enderror">
                               @error('listing_name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text"  id="autocomplete" name="location" class="form-control @error('location') is-invalid @enderror">
                              @error('location')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="contact_email_or_url" class="form-control @error('contact_email_or_url') is-invalid @enderror">
